...
namespace TimeTracker.Infrastructure.Migrations
{
    ...
    [Migration("20250809125216_ModifyingPausePeriod")]
    partial class ModifyingPausePeriod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTracker.Core.Entities.PausePeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeTracker.Core.Entities.PausePeriod", b =>
                {
                    b.HasOne("TimeTracker.Core.Entities.TimeEntry", "TimeEntry")
                        .WithMany("Pauses")
